...
from hard_port.serial.serialutil import *
#~ SerialBase, SerialException, to_bytes, iterbytes

# pylint: disable=wrong-import-position
if sys.platform == 'cli':
    from hard_port.serial.serialcli import Serial
else:
    import os
    # chose an implementation, depending on os
    if os.name == 'nt':  # sys.platform == 'win32':
        from hard_port.serial.serialwin32 import Serial
    elif os.name == 'posix':
        from hard_port.serial.serialposix import Serial, PosixPollSerial, VTIMESerial  # noqa
    elif os.name == 'java':
        from hard_port.serial.serialjava import Serial
    else:
